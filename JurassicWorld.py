...
def plot_decay_timedelta(Timedeltax, max_x=7, n_times=None):
    ...
    # ===== VẼ ĐƯỜNG MƯỢT GỐC =====
    base_curve = total_seconds * (0.9 ** (np.floor(x_curve1 + 0.5) - 0.5))
    ax.plot(x_curve1, base_curve, drawstyle="steps-mid")

    # ==================================================
    # ===== VẼ FILL + TEXT TỪ step_data ===============
    # ==================================================
...
def tab3():  
    ...
    Health3 = st.number_input("3rd Health", min_value=0, value=min(1300, max(int(remain_Fero/3), 2100 - Main_Health)), step=50)  
