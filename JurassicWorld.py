...
def tab3():
    ...
    Health3 = st.number_input("3rd Health", min_value=0, value=int(remain_Fero/6.5), step=50)
    Attack3 = st.number_input("3rd Attack", min_value=0, value=int(remain_Fero/22), step=25)
